...
-- Drop UQ constraint UQ_PVMeasurements_CreatedAt_DeviceId
ALTER TABLE [dbo].[pv_measurements]
DROP CONSTRAINT [UQ_PVMeasurements_CreatedAt_DeviceId];

-- Add new UQ constraint based on createdAt, deviceId, collection_start_time, collection_end_time
ALTER TABLE [dbo].[pv_measurements]
ADD CONSTRAINT [UQ_PVMeasurements_CreatedAt_DeviceId_CollectionStartTime_CollectionEndTime]
