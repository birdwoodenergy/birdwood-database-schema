-- INSERT company_data_provider for BE116_Arnolds_Fruit_Market
...
SET @company_name = 'BE116_Arnolds_Fruit_Market';
...
BEGIN
    ...
    SET @grid_company_data_provider_settings = '{"grid_threshold_in_kw": 1000, "grid_capacity_in_kw": 82.5}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @grid_data_provider_id, 'GRID', '6420ce2d78c5242b783cf9dc', @grid_company_data_provider_settings);

    -- Insert PV Data Provider
    -- double check site_id for pv if correct!
    SET @pv_company_data_provider_settings = '{"pv_capacity_in_kw": 82.5}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @pv_data_provider_id, 'PV', '6420ce2d78c5242b783cf9dc', @pv_company_data_provider_settings);

    -- Insert BESS Data Provider
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id)
    VALUES (@company_id, @bess_data_provider_id, 'BESS', '6420ce2d78c5242b783cf9dc');
END
ELSE
BEGIN
