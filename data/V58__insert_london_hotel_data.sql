...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'London Hotel')
    BEGIN
        PRINT 'Company "London Hotel" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('London Hotel', '12 Mirrool St, Ardlethan NSW 2665, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "London Hotel".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'London Hotel';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DD95335290809';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DD95335290809';
