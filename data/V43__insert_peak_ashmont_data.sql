...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'Peak Ashmont')
    BEGIN
        PRINT 'Company "Peak Ashmont" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('Peak Ashmont', '117 Ashmont Avenue, Ashmont NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "Peak Ashmont".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'Peak Ashmont';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DD25335298299';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DD25335298299';
