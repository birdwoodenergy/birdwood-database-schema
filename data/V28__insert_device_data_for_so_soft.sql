-- INSERT devices for So Soft
DECLARE @company_name NVARCHAR(50) = 'So Soft';
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_6')
END;
...
BEGIN
  -- INSERT pv device
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number)
  VALUES (@pv_company_data_provider_id, 'PV', 'pv_6')
END;
