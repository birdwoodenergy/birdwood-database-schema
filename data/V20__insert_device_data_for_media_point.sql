-- INSERT devices for Media Point
DECLARE @company_name NVARCHAR(50) = 'Media Point';
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_5')
END;
...
BEGIN
  -- INSERT pv device
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number)
  VALUES (@pv_company_data_provider_id, 'PV', 'pv_5')
END;
