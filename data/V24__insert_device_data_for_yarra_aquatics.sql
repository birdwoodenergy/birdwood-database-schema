-- INSERT devices for YR13_Yarra_Aquatics
DECLARE @company_name NVARCHAR(50) = 'YR13_Yarra_Aquatics';
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_10', '000004c001110000', @grid_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id, 'PV', 'pv_10', '000004c101110000', @pv_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@bess_company_data_provider_id, 'BESS', 'bess_6', '000004c201110000', @bess_settings)
END;
