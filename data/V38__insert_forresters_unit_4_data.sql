...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'Forresters - Unit 4')
    BEGIN
        PRINT 'Company "Forresters - Unit 4" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('Forresters - Unit 4', '15-17 Forresters Beach Road, Forresters Beach NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "Forresters - Unit 4".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'Forresters - Unit 4';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DDF4108742304';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DDF4108742304';
