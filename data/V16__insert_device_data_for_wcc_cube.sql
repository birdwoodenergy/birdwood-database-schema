-- INSERT devices for BE111_WCC_Cube
DECLARE @company_name NVARCHAR(50) = 'BE111_WCC_Cube';
...
DECLARE @sub_load_settings NVARCHAR(MAX);
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_1', '000002a001110000', @grid_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id, 'PV', 'pv_1', '000002c001110000', @pv_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@bess_company_data_provider_id, 'BESS', 'bess_1', '000002a101110000', @bess_settings)
END;
...
BEGIN
  ...
  SET @sub_load_settings = '{"sub_load_key": "kW"}';
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@sub_load_company_data_provider_id, 'SUBLOAD', 'sub_load_1', '000000c201110000', @sub_load_settings)
END;
