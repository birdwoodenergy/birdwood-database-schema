...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'Ken Morley')
    BEGIN
        PRINT 'Company "Ken Morley" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('Ken Morley', '19 Houtman Street, East Wagga Wagga NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "Ken Morley".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'Ken Morley';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DD34108227555';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DD34108227555';
