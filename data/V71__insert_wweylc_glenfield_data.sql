...
BEGIN TRY
    DECLARE @company_name NVARCHAR(50) = 'WWEYLC Glenfield';
    ...
    BEGIN
        ...
        VALUES (@company_name, '60 Pinaroo Drive, Glenfield Park NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
    ...
    BEGIN
        SET @grid_device_endpoint = 'DDB5335304926';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DDB5335304926';
