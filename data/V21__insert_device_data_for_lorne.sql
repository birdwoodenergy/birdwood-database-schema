-- INSERT devices for BE122_Lorne
DECLARE @company_name NVARCHAR(50) = 'BE122_Lorne';
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_7', '0000004001110000', @grid_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id, 'PV', 'pv_7', '0000002201110000', @pv_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@bess_company_data_provider_id, 'BESS', 'bess_3', '0000004101110000', @bess_settings)
END;
