...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'Hillview Citrus Packing Shed')
    BEGIN
        PRINT 'Company "Hillview Citrus Packing Shed" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('Hillview Citrus Packing Shed', '1269 Robinson Road, Corbie Hill NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "Hillview Citrus Packing Shed".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'Hillview Citrus Packing Shed';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DDA3710131807';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DDA3710131807';
