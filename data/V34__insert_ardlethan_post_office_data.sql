...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'Ardlethan Post Office')
    BEGIN
        PRINT 'Company "Ardlethan Post Office" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('Ardlethan Post Office', '10 Yithan Street, Ardlethan NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "Ardlethan Post Office".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'Ardlethan Post Office';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DDE4108400973';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DDE4108400973';
