-- INSERT devices for BE105_Sands
DECLARE @company_name NVARCHAR(50) = 'BE105_Sands';
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_8', '000000e001110000', @grid_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id, 'PV', 'pv_8', '0000002201110200', @pv_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@bess_company_data_provider_id, 'BESS', 'bess_4', '000000e101110000', @bess_settings)
END;
