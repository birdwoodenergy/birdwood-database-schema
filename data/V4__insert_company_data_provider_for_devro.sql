-- INSERT company_data_provider for Devro
...
BEGIN
    ...
    SET @grid_company_data_provider_settings = '{"grid_threshold_in_kw": 1250, "grid_capacity_in_kw": 100, "ct_type": "GetMeasurements"}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @grid_data_provider_id, 'GRID', '354616090129219', @grid_company_data_provider_settings);

    -- Insert PV Data Provider
    SET @pv_company_data_provider_settings = '{"pv_capacity_in_kw": 100, "ct_type": "GetMeasurements"}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @pv_data_provider_id, 'PV', '354616090129219', @pv_company_data_provider_settings);
