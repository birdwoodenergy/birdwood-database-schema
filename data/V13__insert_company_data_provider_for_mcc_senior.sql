-- INSERT company_data_provider for BE8002_MCC_Senior
...
SET @company_name = 'BE8002_MCC_Senior';
...
BEGIN
    ...
    SET @grid_company_data_provider_settings = '{"grid_threshold_in_kw": 1000, "grid_capacity_in_kw": 230}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @grid_data_provider_id, 'GRID', '6567e50e4c173061e92c7c45', @grid_company_data_provider_settings);

    -- Insert PV Data Provider
    -- double check site_id for pv if correct!
    SET @pv_company_data_provider_settings = '{"pv_capacity_in_kw": 230}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @pv_data_provider_id, 'PV', '6567e50e4c173061e92c7c45', @pv_company_data_provider_settings);

    -- Insert BESS Data Provider
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id)
    VALUES (@company_id, @bess_data_provider_id, 'BESS', '6567e50e4c173061e92c7c45');
END
ELSE
BEGIN
