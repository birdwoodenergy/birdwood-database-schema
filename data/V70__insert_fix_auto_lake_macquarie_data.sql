...
BEGIN TRY
    DECLARE @company_name NVARCHAR(50) = 'Fix Auto Lake Macquarie';
    ...
    BEGIN
        ...
        VALUES (@company_name, '10 Sturt Rd, Cardiff NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
    ...
    BEGIN
        SET @grid_device_endpoint = 'DD65335169598';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DD65335169598';
