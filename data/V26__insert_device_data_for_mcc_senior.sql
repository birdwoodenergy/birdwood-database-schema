-- INSERT devices for BE8002_MCC_Senior
DECLARE @company_name NVARCHAR(50) = 'BE8002_MCC_Senior';
...
BEGIN
  ...
  VALUES (@grid_company_data_provider_id, 'GRID', 'grid_12', '00000c2101110000', @grid_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_17', '00000c2001110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_18', '00000c2201110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_19', '00000c2301110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_20', '00000d0001110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_21', '00000d0401110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_22', '00000d0301110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_23', '00000d0201110000', @pv_settings)

  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@pv_company_data_provider_id,'PV', 'pv_24', '00000d0101110000', @pv_settings)
END;
...
BEGIN
  ...
  INSERT INTO dbo.device (company_data_provider_id, type, serial_number, endpoint, settings)
  VALUES (@bess_company_data_provider_id, 'BESS', 'bess_8', '00000c0001110000', @bess_settings)
END;
