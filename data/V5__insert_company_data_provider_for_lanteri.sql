-- INSERT company_data_provider for Lanteri
...
SET @company_name = 'Lanteri';
SET @grid_data_provider_name = 'DNA1';
SET @pv_data_provider_name = 'SolarEdge';
...
BEGIN
    ...
    SET @grid_company_data_provider_settings = '{"grid_threshold_in_kw": 1000, "grid_capacity_in_kw": 200}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @grid_data_provider_id, 'GRID', '63f57b95a6aca6208b04f3a1', @grid_company_data_provider_settings);

    -- Insert PV Data Provider
    SET @pv_company_data_provider_settings = '{"pv_capacity_in_kw": 200}';
    INSERT INTO dbo.company_data_provider (company_id, data_provider_id, data_provider_type, site_id, settings)
    VALUES (@company_id, @pv_data_provider_id, 'PV', '1847072', @pv_company_data_provider_settings);
END
ELSE
BEGIN
