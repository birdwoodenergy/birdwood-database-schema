...
BEGIN TRY
    ...
    IF EXISTS (SELECT 1 FROM dbo.company WHERE name = 'BCC- Blacktown Football Park')
    BEGIN
        PRINT 'Company "BCC- Blacktown Football Park" already exists. Skipping insert.';
    END
    ELSE
    BEGIN
        INSERT INTO dbo.company (name, address, timezone, latitude, longitude, contact_number, email_address)
        VALUES ('BCC- Blacktown Football Park', 'Eastern Road, Rooty Hill NSW, Australia', 'Australia/NSW', NULL, NULL, NULL, NULL);
        PRINT 'Inserted company "BCC- Blacktown Football Park".';
    END;
    ...
    DECLARE @company_name NVARCHAR(50) = 'BCC- Blacktown Football Park';
    ...
    BEGIN
        SET @grid_device_endpoint = 'DDD3710131015';
    ...
    BEGIN
        SET @pv_device_endpoint = 'DDD3710131015';
